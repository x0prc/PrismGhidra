...
@FileSystemInfo(type = "fstypegoeshere", // ([a-z0-9]+ only)
		description = "File system description goes here", factory = EnhancedDebuggerIntegrationFileSystem.MyFileSystemFactory.class)
public class EnhancedDebuggerIntegrationFileSystem implements GFileSystem {
	 ...
	 */
	public EnhancedDebuggerIntegrationFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + EnhancedDebuggerIntegrationFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryByteProvider<EnhancedDebuggerIntegrationFileSystem>,
			GFileSystemProbeByteProvider {

		@Override
		public EnhancedDebuggerIntegrationFileSystem create(FSRLRoot targetFSRL,
				ByteProvider byteProvider, FileSystemService fsService, TaskMonitor monitor)
				throws IOException, CancelledException {

			EnhancedDebuggerIntegrationFileSystem fs = new EnhancedDebuggerIntegrationFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
